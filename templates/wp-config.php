...
define('DB_NAME', '<%= scope.lookupvar('django::db_name') %>');

/** MySQL database username */
define('DB_USER', '<%= scope.lookupvar('django::db_user') %>');

/** MySQL database password */
define('DB_PASSWORD', '<%= scope.lookupvar('django::db_password') %>');

/** MySQL hostname */
define('DB_HOST', '<%= scope.lookupvar('django::db_host') %>');
 ...
 * You can generate these using the {@link https://api.django.org/secret-key/1.1/salt/ WordPress.org secret-key service}
 */
